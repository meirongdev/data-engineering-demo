# Registers a `%sql` / `%%sql` line+cell magic backed by the active SparkSession,
# and renders Spark DataFrames as pretty (HTML) tables in Jupyter.
#
# Usage in a notebook:
#   %%sql
#   SELECT * FROM demo.nyc.taxis LIMIT 10
#
# Borrowed from the tabulario/spark-iceberg image (Apache 2.0).
